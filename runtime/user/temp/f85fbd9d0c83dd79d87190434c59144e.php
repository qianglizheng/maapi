<?php /*a:3:{s:60:"D:\phpstudy_pro\WWW\tp6.com\app\user\view\updates\index.html";i:1705484617;s:38:"../app/common/view/public/uHeader.html";i:1697116602;s:38:"../app/common/view/public/uFooter.html";i:1695986854;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'check') {
                    var index = layer.open({
                        ...
                        shadeClose: true,
                        area: ['100%', '100%'],
                        content: '/user/updates/edit',
                        success: function (layero, index) {
                            var body = layui.layer.getChildFrame('body', index);
                            body.find(".id").val(data.id);
                            body.find(".content").val(data.content);
                            body.find(".download_url").val(data.download_url);
