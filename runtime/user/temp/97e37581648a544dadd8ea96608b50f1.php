<?php /*a:3:{s:59:"D:\phpstudy_pro\WWW\tp6.com\app\user\view\updates\edit.html";i:1697467924;s:38:"../app/common/view/public/uHeader.html";i:1697116602;s:38:"../app/common/view/public/uFooter.html";i:1695986854;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <script>
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(saveBtn)', function (data) {
                $.ajax({
                    url: `/api/user/v1/updates/${data.field.id}`, //请求url
                    method: 'PUT', //请求方法
