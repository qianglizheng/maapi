<?php /*a:3:{s:60:"D:\phpstudy_pro\WWW\tp6.com\app\admin\view\config\Email.html";i:1682947839;s:37:"../app/common/view/public/header.html";i:1682947624;s:37:"../app/common/view/public/footer.html";i:1682947773;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <script>
        layui.use(['form', 'miniTab'], function () {
            ...
            //获取信息
            $.get('/api/admin/v1/email/1', {}, function (res) {
                    if (res.code == '200') {
            ...
            form.on('submit(saveBtn)', function (data) {
                ...
                $.post('/api/admin/v1/email/1', data.field, function (res) {
                    if (res.code == '200') {
